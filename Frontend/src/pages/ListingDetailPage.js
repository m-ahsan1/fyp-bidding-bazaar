...
const ListingDetailPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await apiServerNode.get(`/api/listings/${id}`);
                ...
                <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-600"><strong>Transmission:</strong> {carData.transmission}</p>
                        ...
                        {auth.currentUser ? (
                            auth.currentUser.uid === carData.uid ? (
                            ...
                            <p className="text-gray-600">Please log in to view contact information and manage this listing.</p>
                        )}
                    </div>
                </div>
            </div>
